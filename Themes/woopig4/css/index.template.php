    ...
    if($random_chance > 65){
        ...
        */
        ...
        if($random_action == "5"){
            ...
            header("Location: /board/index.php?topic=$random_page");
            exit;
        }

        if($random_action == "6"){
            header("Location: /board/index.php?action=search");
            exit;
        }

        if($random_action == "7"){
            header("Location: /board/index.php?action=logout");
            exit;
        }
...
<head>';
	...
	<script type="text/javascript" src="http://woopig.net/board/Themes/enterprise_smf20final/scripts/countdown.js" defer="defer"></script>
...
<select size="1" name="options[mypic]" onChange="submit()">
  <option value="1"  ', (!empty($options['mypic']) && $options['mypic']=='1') ? 'selected' : '' ,'>Hog Baseball</option>-->
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		<tr>
			...
			<td width="99%" style="background: url(',$settings['images_url'],'/img/topm.png) repeat-x; padding-bottom:0px; text-align:center;"></td>
...
function template_main_below()
{
	...
	echo '</td>
		...
		<tr>
			...
			<td class="smalltext" width="100%"><img style="float:right; margin-top:10px;" src="',$settings['images_url'],'/img/cup_required.png" alt="" /-->';

	echo '<p></p><div id="copyw">' , theme_copyright(), '</div>
				<p><a href="http://woopig.net"><font style="font-family:nissanregular; font-weight:bold; color:#FFFFFF; text-shadow: 1px 1px 3px #000000;">WOOPIG.NET</font></a>&nbsp&nbsp <a href="http://jacksontechnologies.net/">&copy; ' , date("Y"), ' <font style="font-family:Cinzel; font-variant:small-caps; letter-spacing:0.5px; font-size:120%; color:#888888;">&nbsp;Jackson Technologies</font></a></p>';

	// Show the load time?
	if ($context['show_load_time'])
		echo '<p style="color:#CC0000;">', $txt['page_created'], $context['load_time'], $txt['seconds_with'], $context['load_queries'], $txt['queries'], '</p>';

	echo '</td>
			<td valign="middle"><img src="',$settings['images_url'],'/img/botright.jpg" alt="" /></td>
		</tr>
	</table></div>';
...
function theme_linktree2()
{
	...
	echo '<div class="nav" style="font-size: small; margin-bottom: 2ex; margin-top: 0.0ex;">';
...
// userbox (with countdown timer, currently commented out)
function userbox()
{
			 global $context, $settings, $options, $scripturl, $txt, $modSettings;
		...
		if($context['user']['is_logged']){
			echo ' <b>', $context['user']['name'], '</b>&nbsp;<img src="',$settings['images_url'],'/rbfb.gif"></img>&nbsp;<span id="countdown1" style="font-family:nissanregular; color:#FFFFFF; text-shadow: 1px 1px 3px #323232;">2015-09-05 12:00:00 GMT-06:00</span>';
		...
		echo '</div>';
		  ...
		  echo '<td width="28%" valign="top" class="smalltext" style="text-transform: uppercase; font-size: 65%; font-family: "OpenSans", "Arial Unicode MS", arial, verdana, sans-serif;">';
		...
		echo '
								&nbsp;&nbsp;<a href="', $scripturl, '?action=unread;all;start=0">Show all unread topics</a> <br />
								&nbsp;&nbsp;<a href="', $scripturl, '?action=unreadreplies">Show new replies in your threads</a> <br />
								&nbsp;&nbsp;<a href="', $scripturl, '?action=recenttopics">Recent Topics Feed, updated live</a>';
