...
function userbox()
{
		...
		if($context['user']['is_logged']){
			echo ' <b>', $context['user']['name'], '</b>&nbsp;<img src="',$settings['images_url'],'/rbfb.gif"></img>&nbsp;<span class="countdown" id="countdown1">2015-09-05 12:00:00 GMT-06:00</span>';
		...
		echo '
								<div class="smalltext">&nbsp;&nbsp;<a href="', $scripturl, '?action=unread;all;start=0">Show all unread topics.</a> <br />
								&nbsp;&nbsp;<a href="', $scripturl, '?action=unreadreplies">', $txt['show_unread_replies'],'</a> <br />
								&nbsp;&nbsp;<a href="', $scripturl, '?action=recenttopics">Recent Topics Feed, updated live.</a></div>';
