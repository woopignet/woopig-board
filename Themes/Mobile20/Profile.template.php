...
* Copyright (c) 2015-2019 by SMFMobileTheme.com All rights reserved.       		  *
...
<div data-role="header" style="overflow:hidden;" data-position="fixed">
	...
	<div data-role="navbar">
		<ul>
			<li><a href="', $scripturl, '?action=profile;u=', $context['member']['id'],'" class="ui-btn-active">', $txt['summary'],'</a></li>
			<li><a href="', $scripturl, '?action=profile;u=', $context['member']['id'],';area=showposts">', $txt['showMessages'],'</a></li>
			<li><a href="', $scripturl, '?action=profile;u=', $context['member']['id'],';area=showposts;sa=topics">', $txt['showTopics'],'</a></li>
		</ul>
	</div><!-- /navbar -->
</div><!-- /header -->
...
echo'
	<div class="ui-grid-a">
		...
		if (!empty($context['member']['avatar']['image']))
			...
			echo'
			<img src="', $settings['images_url'], '/no_avatar.png" width="80px" alt="" />';
			
echo '
		</div>
		<div class="ui-block-b" display-inline="true">
			<strong>
			...
			<p>
				...
				if ($context['can_send_pm'])
					echo '
				<a href="' . $context['member']['online']['href'] . '" class="ui-shadow ui-btn ui-btn-inline">', $txt['profile_sendpm_short'], '</a>';
...
<ul data-role="listview" data-inset="true" data-divider-theme="a">';
	...
	if (!isset($context['attachments']))
	{
		...
		<li data-role="list-divider">
			#', $post['counter'], ' - ', $post['subject'], ' ', $txt['on'], ' ', $post['time'], '
			<a href="#popupMenuMsg', $post['counter'], '" data-rel="popup" data-transition="slideup" data-icon="bars" class="ui-btn-right ui-link ui-btn ui-icon-bars ui-btn-icon-notext ui-shadow ui-corner-all" style="position: absolute;top: 0;">
				', $txt['actions'], '
			</a>
		<li>
		...
		<div data-role="popup" id="popupMenuMsg', $post['counter'], '" data-theme="b">
			<ul data-role="listview" data-inset="true" style="min-width:210px;">
						<li><a href="', $scripturl, '?topic=', $post['topic'], '.msg', $post['id'], '#msg', $post['id'], '">', $txt['view_post'], '</a></li>';
