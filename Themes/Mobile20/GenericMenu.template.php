...
function template_generic_menu_sidebar_above()
{
	...
	{
		echo'
			<option disabled="disabled" value="', $scripturl,'?action=admin">', $section['title'], '</option>';
		...
		foreach ($section['areas'] as $i => $area)
		{
			...
			echo '
					<option value="', isset($area['url']) ? $area['url'] : $menu_context['base_url'] . ';area=' . $i, $menu_context['extra_parameters'], '"', ($i == $menu_context['current_area'] ? ' selected="selected"' : ''), '>
						|-- ', $area['label'], '
					</option>';
		}
	}
