...
<div role="main" class="ui-content">';
		...
		<form action="', $scripturl, '?action=register2" method="post" accept-charset="', $context['character_set'], '" name="registration" id="registration" onsubmit="return verifyAgree();">
			<div class="windowbg2">
				...
				<fieldset class="content">
						...
						<strong><label for="smf_autov_reserve1">', $txt['email'], ':</label></strong>
						...
						<select name="allow_email" id="allow_email" data-role="slider" tabindex="', $context['tabindex']++, '">
	...
	echo '
					<div>
						<div><strong><label for="smf_autov_pwmain">', $txt['choose_pass'], ':</label></strong></div>
						<div>
							<input type="password" name="passwrd1" id="smf_autov_pwmain" size="30" tabindex="', $context['tabindex']++, '" class="input_password" />
						</div>
					</div>
					<div class="register_form" id="password2_group">
						<div><strong><label for="smf_autov_pwverify">', $txt['verify_pass'], ':</label></strong></div>
						<div>
	...
	if (!empty($modSettings['enableOpenID']))
	{
		echo '
					...
					<div class="register_form" id="openid_group">
						<div><strong>', $txt['authenticate_openid_url'], ':</strong></div>
						<div>
	...
	if (!empty($context['profile_fields']) || !empty($context['custom_fields']))
	{
		echo '
			...
			<div class="register_form" id="custom_group">';
	}
