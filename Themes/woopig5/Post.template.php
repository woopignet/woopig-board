	...
	echo '
					<div id="postMoreOptions" class="smalltext">
						<ul class="post_options">
							...
							', $user_info['is_admin'] ? '<li><label for="check_hide_edit"><input type="checkbox" name="hide_modify" id="check_hide_edit" class="input_check" /> </label></li>' : '', '
