...
function template_main()
{
	...
	<div id="posting_icons" class="floatleft">';
		...
		<ul class="reset">
			...
			<li class="floatleft"><img src="', $settings['images_url'], '/', $context['theme_variant_url'], 'new_redirect.png" alt="" /> How About You Go Fuck Yourself?</li>
		</ul>
	</div>';
...
function template_info_center()
{
	...
	if ($settings['show_stats_index'])
	{
		echo '
			<div class="title_barIC">
				<h4 class="titlebg">
					<span class="ie6_header floatleft">
						<a href="', $scripturl, '?action=stats">Woopig Statistics</a>
					</span>
				</h4>
			</div>
			<p>
	...
	echo '
			<div class="title_barIC">
				<h4 class="titlebg">
					<span class="ie6_header floatleft">
						', $context['show_who'] ? '<a href="' . $scripturl . '?action=who' . '">' : '', 'Online Woopiggers', $context['show_who'] ? '</a>' : '', '
