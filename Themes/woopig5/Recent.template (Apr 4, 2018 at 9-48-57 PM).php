			...
			<div class="', $post['alternate'] == 0 ? 'windowbg' : 'windowbg2', ' core_posts">
				...
				<div class="content">
					...
					<div class="topic_details">
						...
						<span>&#171;&nbsp;', $txt['last_post'], ' ', $txt['by'], ' <strong>', $post['poster']['link'], ' </strong> ', $txt['on'], '<em> ', $post['time'], '</em>&nbsp;&#187;</span>
					</div>
			...
			echo '
						<tr>
							...
							<td class="subject ', $color_class2, ' windowbg2">
								<div>
									', $topic['is_sticky'] ? '<strong>' : '', '<span title="', $topic['first_post']['preview'], '"><span id="msg_' . $topic['first_post']['id'] . '">', $topic['first_post']['link'], '</span></span>', $topic['is_sticky'] ? '</strong>' : '', '
		...
		foreach ($context['topics'] as $topic)
		{
			echo '
				<tr class="windowbg', ($alt ? '2' : ''), '" id="topic_', $topic['id'], '">
					<td style="font-size: 1.0em; padding-left: 10px; border-bottom: 1px solid rgb(204, 204, 204);">', $topic['board']['link'], '</td>
					<td style="font-size: 1.0em; padding-left: 10px; border-bottom: 1px solid rgb(204, 204, 204);">', $topic['link'], '</td>
					<td align="center" style="font-size: 1.0em; border-bottom: 1px solid rgb(204, 204, 204);">', $topic['replies'], '</td>
					<td align="center" style="font-size: 1.0em; border-bottom: 1px solid rgb(204, 204, 204);">', $topic['firstPoster']['link'], '<br />', $topic['firstPoster']['time'], '</td>
					<td align="center" style="font-size: 1.0em; border-bottom: 1px solid rgb(204, 204, 204);">', $topic['lastPoster']['link'], '<br />', $topic['lastPoster']['time'], '</td>
					<td align="center" style="font-size: 1.0em; border-bottom: 1px solid rgb(204, 204, 204);"><a href="', $topic['lastPost']['href'], '"><img src="', $settings['images_url'], '/icons/last_post.gif" alt="', $txt['last_post'], '" title="', $txt['last_post'], '" /></a></td>
				</tr>';
		$alt = !$alt;
		}
