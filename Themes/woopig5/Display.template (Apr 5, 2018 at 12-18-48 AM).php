...
function template_main()
{
	...
	while ($message = $context['get_message']())
	{
		...
		if ($likeRandom == 0)
			$likeString='<button class="like_button"><font color="#CC0000" onclick="javascript:alert(\'This is Woopig. You are not supposed to *like* anything.\')"><img src="http://woopig.net/board/Themes/woopig5/images/like.png"></font>&nbsp;</button>';
		
		elseif ($likeRandom == 1)
			$likeString='<button class="like_button"><font color="#CC0000" onclick="javascript:alert(\'Congratulations, you are a colossal douche.\')"><img src="http://woopig.net/board/Themes/woopig5/images/like.png"></font>&nbsp;</button>';
		
		elseif ($likeRandom == 2)
			$likeString='<button class="like_button"><font color="#CC0000" onclick="javascript:alert(\'Woopig would *like* for you to go fuck yourself, and then die in a chemical fire. Please update us.\')"><img src="http://woopig.net/board/Themes/woopig5/images/like.png"></font>&nbsp;</button>';
			
		elseif ($likeRandom == 3)
			$likeString='<button class="like_button"><font color="#CC0000" onclick="javascript:alert(\'Stop *liking* things on the Internet, it is obnoxious.\')"><img src="http://woopig.net/board/Themes/woopig5/images/like.png"></font>&nbsp;</button>';
			
		elseif ($likeRandom == 4)
			$likeString='<button class="like_button"><font color="#CC0000" onclick="javascript:alert(\'You may like this post, but nobody likes you.\')"><img src="http://woopig.net/board/Themes/woopig5/images/like.png"></font>&nbsp;</button>';
			
		elseif ($likeRandom == 5)
			$likeString='<button class="like_button"><font color="#CC0000" onclick="javascript:alert(\'Nobody cares what you like.\')"><img src="http://woopig.net/board/Themes/woopig5/images/like.png"></font>&nbsp;</button>';
		
		elseif ($likeRandom == 6)
			$likeString='<button class="like_button"><font color="#CC0000" onclick="javascript:alert(\'Even ISIS thinks you are terrible.\')"><img src="http://woopig.net/board/Themes/woopig5/images/like.png"></font>&nbsp;</button>';
			
		elseif ($likeRandom == 7)
			$likeString='<button class="like_button"><font color="#CC0000" onclick="javascript:alert(\'Everyone here would *like* to see you shot into the sun.\')"><img src="http://woopig.net/board/Themes/woopig5/images/like.png"></font>&nbsp;</button>';
			
		elseif ($likeRandom == 8)
			$likeString='<button class="like_button"><font color="#CC0000" onclick="javascript:alert(\'By liking something on the Internet, you have failed your entire family.\')"><img src="http://woopig.net/board/Themes/woopig5/images/like.png"></font>&nbsp;</button>';
			
		elseif ($likeRandom == 9)
			$likeString='<button class="like_button"><font color="#CC0000" onclick="javascript:alert(\'Thanks for liking this Woopig post!  Please message an Admin with your Facebook and Twitter account names so we can get to know you better!\')"><img src="http://woopig.net/board/Themes/woopig5/images/like.png"></font></button>&nbsp;';
				
		elseif ($likeRandom == 10)
			$likeString='<button class="like_button"><font color="#CC0000" onclick="javascript:alert(\'Woopig hopes that your silent tears go unnoticed.\')"><img src="http://woopig.net/board/Themes/woopig5/images/like.png"></font>&nbsp;</button>';
			
		elseif ($likeRandom == 11)
			$likeString='<button class="like_button"><font color="#CC0000" onclick="javascript:alert(\'Woopig invites you to suck a forklift pallet full of dicks.\')"><img src="http://woopig.net/board/Themes/woopig5/images/like.png"></font>&nbsp;</button>';
			
		elseif ($likeRandom == 12)
			$likeString='<button class="like_button"><font color="#CC0000" onclick="javascript:alert(\'Woopig hopes that the taints of your relatives are punctured by the penises of your enemies.\')"><img src="http://woopig.net/board/Themes/woopig5/images/like.png"></font>&nbsp;</button>';
			
		elseif ($likeRandom == 13)
			$likeString='<button class="like_button"><font color="#CC0000" onclick="javascript:alert(\'Like Like Like Like Like.  Great work.  Why not do something productive with your life?\')"><img src="http://woopig.net/board/Themes/woopig5/images/like.png"></font>&nbsp;</button>';
			
		elseif ($likeRandom == 14)
			$likeString='<button class="like_button"><font color="#CC0000" onclick="javascript:alert(\'Come on, asshole.  Just stop it.\')"><img src="http://woopig.net/board/Themes/woopig5/images/like.png"></font>&nbsp;</button>';
			
		elseif ($likeRandom == 15)
			$likeString='<button class="like_button"><font color="#CC0000" onclick="javascript:alert(\'Woopig does not *like* you.  In fact, Woopig hates you, and prefers that you just leave.\')"><img src="http://woopig.net/board/Themes/woopig5/images/like.png"></font>&nbsp;</button>';
			
		elseif ($likeRandom == 16)
			$likeString='<button class="like_button"><font color="#CC0000" onclick="javascript:alert(\'Admit it, whatever you *like* pretty much always turns out to be terrible.\')"><img src="http://woopig.net/board/Themes/woopig5/images/like.png"></font>&nbsp;</button>';
			
		elseif ($likeRandom == 17)
			$likeString='<button class="like_button"><a href="http://www.hogville.net/yabbse/"><img src="http://woopig.net/board/Themes/woopig5/images/like.png"></a>&nbsp;</button>';
			
		elseif ($likeRandom == 18)
			$likeString='<button class="like_button"><a href="http://www.helpguide.org/articles/addiction/internet-and-computer-addiction.htm"><img src="http://woopig.net/board/Themes/woopig5/images/like.png"></a>&nbsp;</button>';
...
/* original code - keeping for a bit */
	...
	// Show the page index... "Pages: [1]".
	//xxSHxx 20180317 - changed All Unread Topics to have entire box clickable - display:inline-block and the div inside the anchor are the keys
	echo '
			<div class="pagesection">
				...
				. ' &nbsp;&nbsp;<a href="#top"><strong>' . $txt['go_up'] . '</strong></a>
				<!-- <br> --><br><br>
				<a style="color:white;" href=http://woopig.net/board/index.php?action=unread;all;start=0><div class="boxlinks_bottom_l" style="display:inline-block;">&nbsp;All Unread Topics&nbsp;</div></a>
				
				<!-- <br><br><br>
				
				<div class="boxlinks_bottom_l">&nbsp&nbsp PREVIOUS | &nbsp&nbsp</div>
				
				<div class="boxlinks_bottom_r">&nbsp&nbsp | NEXT &nbsp&nbsp</div> -->
	...
	//xxSHxx 20180311 try to add the lower breadcrumb - theme_linktree() was in place in index.template.php but does nothing
	//theme_linktree();
	theme_linktree2();
	echo '<br>';
