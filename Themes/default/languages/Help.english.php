...
$helptxt['tp_deep_link_enabled'] = 'Allow your members to open the same thread in Tapatalk from your Facebook post / Twitter tweet.';
//Tapatalk IAR
$helptxt['tp_iar_registration_options'] = 'In App Registration - Allows Tapatalk users to register your forum easily with in-app registration, Tapatalk supports all custom and required fields such as birthday control and any extra fields you requires new members to enter.<br />
