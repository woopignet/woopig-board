		...
		if (is_array($config_var))
		{
			...
			else
			{
				...
				elseif ($config_var['type'] == 'large_text')
					echo '
							<textarea rows="', ($config_var['size'] ? $config_var['size'] : 4), '" cols="',(isset($config_var['cols']) && intval($config_var['cols']) ? intval($config_var['cols']) : 30),'" ', $javascript, $disabled, ' name="', $config_var['name'], '" id="', $config_var['name'], '">', $config_var['value'], '</textarea>';
				// Permission group?
