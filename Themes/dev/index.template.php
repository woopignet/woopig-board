...
<head>';
	...
	<script type="text/javascript" src="http://woopig.net/board/Themes/dev/scripts/countdown.js" defer="defer"></script>
...
if ($context['browser']['is_ie8'] || $context['browser']['is_ie7'] || $context['browser']['is_ie6'])
	...
	<div id="mainmenu">' , template_menu() , '</div><div class="css-slideshow"> 
  		<figure> 
    		<img src="',$settings['images_url'],'/rotate/WP1h.png"/> 
		</figure>
		<figure> 
...
function template_main_below()
{
	...
	if ($context['show_load_time'])
		echo '<p class="smalltext" style="color:#CC0000;">', $txt['page_created'], $context['load_time'], $txt['seconds_with'], $context['load_queries'], $txt['queries'], '</p>';
