...
function detectBrowser()
{
	...
	//xxSHxx 20180311
	//added more mobile checks in this array to fix errors in index.template.php
	//adding tapatalk dummy variable to stop errors
	...
	<script type="text/javascript">
		...
		if (oTwitter.length > 0) {
			oTwitter.each(function() {
				...
				sStr = sStr.replace(/\/+$/, "");
				//xxSHxx 20180317 fixing ending variable after twitter ID - e.g., 343254355?s=21 - the ?s=21 causes this to fail
				sStr = sStr.substr(sStr.lastIndexOf(\'/\') + 1); //original code
				var idx = sStr.indexOf(\'?\');
				if (idx > 0) {
					sStr = sStr.substring(0, idx);
				}
		...
		$(document).ready(function () {
			$(\'.expand\').click(function (e) {
				...
				}).parent().find(\'blockquote\').first().toggleClass(\'expanded\');
